          ...
          <div className="container-basic-information">
            <div className="form-group">
              <div className="form-item">
                ...
                <select id="personal-city-list" name="personal-city-list">
                  <option value="personal-city-HCM">
                    Thành Phố Hồ Chí Minh
                  </option>
                  <option value="personal-city-HaNoi">Thành Phố Hà Nội</option>
                </select>
              ...
              <div className="form-item">
                ...
                <select
                  ...
                  disabled
                >
                  <option value="personal-district-1">Quận 1</option>
                  <option value="personal-district-2">Quận 2</option>
                  <option value="personal-district-3">Quận 3</option>
                </select>
            ...
            <div className="form-group">
              <div className="form-item">
                ...
                <select
                  ...
                  disabled
                >
                  <option value="personal-ward-HCM-1">Phường Bến Nghé</option>
                  <option value="personal-ward-HCM-2">Phường Bến Thành</option>
                </select>
          ...
          <div className="container-basic-information">
            <div className="form-group">
              <div className="form-item">
                ...
                <select id="enterprise-city-list" name="enterprise-city-list">
                  <option value="enterprise-city-HCM">
                    Thành Phố Hồ Chí Minh
                  </option>
                  <option value="enterprise-city-HaNoi">
                    Thành Phố Hà Nội
                  </option>
                </select>
                <span className="error-message">Vui lòng chọn tỉnh/thành</span>
              ...
              <div className="form-item">
                ...
                <select
                  ...
                  disabled
                >
                  <option value="enterprise-district-1">Quận 1</option>
                  <option value="enterprise-district-2">Quận 2</option>
                  <option value="enterprise-district-3">Quận 3</option>
                </select>
                <span className="error-message">Vui lòng chọn quận/huyện</span>
              </div>
            </div>
            ...
            <div className="form-group">
              <div className="form-item">
                ...
                <select
                  ...
                  disabled
                >
                  <option value="enterprise-ward-HCM-1">Phường Bến Nghé</option>
                  <option value="enterprise-ward-HCM-2">
                    Phường Bến Thành
                  </option>
                </select>
                <span className="error-message">Vui lòng chọn phường/xã</span>
