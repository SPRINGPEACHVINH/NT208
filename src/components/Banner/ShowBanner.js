        ...
        <div class="banner">
            ...
            <div
                ...
                <div class="style-mobile container1 mobile">
                    <div id="bg-wrapper">
                        <img src="https://salt.tkbcdn.com/ts/ds/1a/52/a2/4303c4da7ba6e5806b06e9d40a91d0c5.png" alt="Banner cover blurred" />
                    </div>
                    <div id="banner-info-wrapper">
                        <div id="banner-info-stack">
                            <div id="banner-img-wrapper">
                                <img src="https://salt.tkbcdn.com/ts/ds/1a/52/a2/4303c4da7ba6e5806b06e9d40a91d0c5.png" alt="Banner cover main display"/>
                            </div>
            ...
            <div
                ...
                <div class="style-wrapper wrap mobile">
                    <div class="style-mobile container2">
                        ...
                        <a href="#ticket-info">
                            <button id="select-showing-btn" class="style-select showingBtn">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon" id="my-ticket-icon">
